# Generated by Django 2.2.6 on 2020-01-30 17:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0024_remove_details_details_visible'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_detail', models.CharField(choices=[('Battery', 'Battery'), ('Back_cover', 'Back_cover'), ('Camera_back', 'Camera_back'), ('Camera_front', 'Camera_front'), ('Flex_charging', 'Flex_charging'), ('Flex_ON/OFF', 'Flex_ON/OFF'), ('Flex_camera', 'Flex_camera'), ('LCD_module', 'LCD_module'), ('LCD', 'LCD'), ('Touch', 'Touch')], max_length=20)),
                ('detail_quality', models.CharField(choices=[('SP', 'SP'), ('OR', 'OR'), ('HQ', 'HQ'), ('COPY', 'COPY')], max_length=10)),
                ('detail_comment', models.CharField(default='*', max_length=20)),
